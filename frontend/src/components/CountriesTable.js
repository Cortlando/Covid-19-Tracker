...
function createData(country, totalCases, totalRecovered, totalDeaths, percentChange) {
  return { country, totalCases, totalRecovered, totalDeaths, percentChange };
}
/*
const rows = [
  createData('United States', 816336, 698105, 176268, 3.7),
  createData('Spain', 204178, 82676, 45172, 7.31),
  createData('Italy', 183957, 82514, 24648, 1.51),
  createData('France', 158050, 39181, 20796, 1.79),
  createData('Germany', 148291, 95200, 5033, 0.83),
  createData('United Kingdom', 124743, 1918, 16509, 0),
  createData('Turkey', 95591, 14918, 2259, 5.07),
  createData('China', 88423, 82702, 4623, 6.86),
  createData('Iran', 84802, 60965, 5297, 1.55),
  createData('Russia', 52763, 3873, 456, 11.97),
];
...
const rows = [getData()]
console.log("afkhafjkgafjkh" + rows)
...
const headCells = [
  ...
  { id: 'totalCases', numeric: true, disablePadding: false, label: 'Cases' },
  { id: 'totalRecovered', numeric: true, disablePadding: false, label: 'Recovered' },
